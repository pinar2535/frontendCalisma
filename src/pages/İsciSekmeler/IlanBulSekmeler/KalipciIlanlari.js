...
const kalipcilarIlanlari = [
    { sirketAd: "kalipcilarIlanlari", tarih: "21/7/2024", istanımı: "istanımı", islokasyon: "rgrteh" },
...
const KalipciIlanlari = () => {
    ...
    return (
        <Grid container spacing={1}>
            {kalipcilarIlanlari.map((ilan, index) => (
...
export default KalipciIlanlari;