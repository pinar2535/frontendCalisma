...
const ustaYardimcilariIlan = [
    { sirketAd: "ustaYardimcilariIlan", tarih: "21/7/2024", istanımı: "istanımı", islokasyon: "rgrteh" },
...
const UstaYardimcisiIlanlari = () => {
    ...
    return (
        <Grid container spacing={1}>
            {ustaYardimcilariIlan.map((ilan, index) => (
...
export default UstaYardimcisiIlanlari;