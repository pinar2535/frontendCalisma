...
const demirciIlanlari = [
    { sirketAd: "demirciIlanlari", tarih: "21/7/2024", istanımı: "istanımı", islokasyon: "rgrteh" },
...
const DemirciIlanlari = () => {
    ...
    return (
        <Grid container spacing={1}>
            {demirciIlanlari.map((ilan, index) => (
...
export default DemirciIlanlari;