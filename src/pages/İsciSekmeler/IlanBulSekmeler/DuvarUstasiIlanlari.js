...
const duvarUstalariIlanlari = [
    { sirketAd: "duvarUstalariIlanlari", tarih: "21/7/2024", istanımı: "istanımı", islokasyon: "rgrteh" },
...
const DuvarUstasiIlanlari = () => {
    ...
    return (
        <Grid container spacing={1}>
            {duvarUstalariIlanlari.map((ilan, index) => (
...
export default DuvarUstasiIlanlari;
