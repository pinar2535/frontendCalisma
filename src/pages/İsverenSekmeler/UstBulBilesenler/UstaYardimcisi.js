...
const ustaYardimcilari = [
    { sirketAd: "ustaYardimcilari", tarih: "21/7/2024", istanımı: "istanımı", islokasyon: "rgrteh" },
...
const UstaYardimcisi = () => {
    ...
    return (
        <Grid container spacing={1}>
            {ustaYardimcilari.map((ilan, index) => (
